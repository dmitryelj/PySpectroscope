...
This app should work on any system capable to run Tkinter, NumPy and OpenCV (Windows, OSX, Linux, Raspberry Pi).
...
- Open the saved png file in the image editor, find the x-coordinates of 2 known peaks (for a fluorescent lamp, can be found in Wikipedia).
